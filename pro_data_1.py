# -*- coding: utf-8 -*-
"""
Created on Sat Dec  9 19:59:58 2017
...
with open('out_b_17.csv','r') as f:
  content =[line.strip() for line in f.readlines()]
  
with open('out_b_17_face.csv','r') as f:
...
#with open('out_b_19_21.csv','w') as f1:
