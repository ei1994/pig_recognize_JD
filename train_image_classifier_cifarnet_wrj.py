...
tf.app.flags.DEFINE_string(
    'master', None, 'The address of the TensorFlow master to use.')
...
#  PRETRAINED_CHECKPOINT_DIR='D:/pig_recognize/pig_slim1/checkpoints'
...
#  MODEL_NAME='model.ckpt-55000'
  ...
  TRAIN_DIR='D:/pig_recognize/pig_slim1/flowers-models/inception_resnet_v2'
...
#  FLAGS.max_number_of_steps=45000 
#  FLAGS.batch_size=128 
#  FLAGS.learning_rate=0.01 
#  FLAGS.learning_rate_decay_type='fixed' 
#  FLAGS.save_interval_secs=500 
#  FLAGS.save_summaries_secs=500
#  FLAGS.log_every_n_steps=20 
#  FLAGS.optimizer='rmsprop' 
#  FLAGS.weight_decay=0.00004
  
  FLAGS.train_dir='D:/pig_recognize/pig_slim1/flowers-models/inception_resnet_v2/all' 
  FLAGS.dataset_name='cifar10' 
  FLAGS.dataset_split_name='train' 
  FLAGS.dataset_dir=DATASET_DIR
  FLAGS.model_name=MODEL_NAME
  FLAGS.checkpoint_path=TRAIN_DIR 
  FLAGS.max_number_of_steps=85000 
  FLAGS.batch_size=28
  FLAGS.learning_rate=0.0001 
  FLAGS.learning_rate_decay_type='fixed' 
  FLAGS.save_interval_secs=100 
  FLAGS.save_summaries_secs=100 
  FLAGS.log_every_n_steps=20 
  FLAGS.optimizer='rmsprop' 
  FLAGS.weight_decay=0.00004
